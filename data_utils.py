...
class MockRandomForest:
    ...
    def predict_proba(self, df):
        # Arginine lowers risk, Moisture increases risk, Hardness lowers risk slightly
        score = (df['Moisture (%)'] * 2.0) - (df['Arginine (%)'] * 0.5) - (df['Hardness (kp)'] * 0.1)
        # Map to a probability using a sigmoid function
